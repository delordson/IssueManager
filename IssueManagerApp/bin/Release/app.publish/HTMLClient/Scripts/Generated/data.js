...
(function (lightSwitchApplication) {
    ...
    msls._addToNamespace("msls.application", {
        ...
        ApplicationData: $defineDataService(ApplicationData, lightSwitchApplication.rootUri + "/ApplicationData.svc", [
            ...
            {
                name: "MyIssues", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.Issues },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/MyIssues()",
                        {
                        });
                }
            },
            {
                name: "MyFurtherActions", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.FurtherActions },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/MyFurtherActions()",
                        {
                        });
                }
            }
