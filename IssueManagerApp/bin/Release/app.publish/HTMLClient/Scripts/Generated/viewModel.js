...
(function (lightSwitchApplication) {
    ...
    function BrowseMyFurtherActions(parameters, dataWorkspace) {
        /// <summary>
        /// Represents the BrowseMyFurtherActions screen.
        /// </summary>
        /// <param name="parameters" type="Array">
        /// An array of screen parameter values.
        /// </param>
        ...
        /// An existing data workspace for this screen to use. By default, a new data workspace is created.
        /// </param>
        /// <field name="MyFurtherActions" type="msls.VisualCollection" elementType="msls.application.FurtherAction">
        /// Gets the myFurtherActions for this screen.
        /// </field>
        /// <field name="Search" type="String">
        /// Gets or sets the search for this screen.
        /// </field>
        /// <field name="details" type="msls.application.BrowseMyFurtherActions.Details">
        /// Gets the details for this screen.
        /// </field>
        if (!dataWorkspace) {
            dataWorkspace = new lightSwitchApplication.DataWorkspace();
        }
        $Screen.call(this, dataWorkspace, "BrowseMyFurtherActions", parameters);
    }

    function BrowseMyIssues(parameters, dataWorkspace) {
        /// <summary>
        /// Represents the BrowseMyIssues screen.
        /// </summary>
        /// <param name="parameters" type="Array">
        /// An array of screen parameter values.
        /// </param>
        ...
        /// An existing data workspace for this screen to use. By default, a new data workspace is created.
        /// </param>
        /// <field name="MyIssues" type="msls.VisualCollection" elementType="msls.application.Issue">
        /// Gets the myIssues for this screen.
        /// </field>
        /// <field name="Search" type="String">
        /// Gets or sets the search for this screen.
        /// </field>
        /// <field name="details" type="msls.application.BrowseMyIssues.Details">
        /// Gets the details for this screen.
        /// </field>
        if (!dataWorkspace) {
            dataWorkspace = new lightSwitchApplication.DataWorkspace();
        }
        $Screen.call(this, dataWorkspace, "BrowseMyIssues", parameters);
    }
    ...
    msls._addToNamespace("msls.application", {
        ...
        BrowseEmployees: $defineScreen(BrowseEmployees, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.Employees.filter("(" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", FirstName)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", LastName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", UserName)") + "");
                }
            },
        ...
        BrowseIssues: $defineScreen(BrowseIssues, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.Issues.filter("((" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", IssueTitle)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", IssueDescription)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Priority)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Status)") + "").expand("IssueType").expand("AssignedTo");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseIssueTypes: $defineScreen(BrowseIssueTypes, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.IssueTypes.filter("" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", IssueTypeName)") + "");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseMyFurtherActions: $defineScreen(BrowseMyFurtherActions, [
            {
                name: "MyFurtherActions", kind: "collection", elementType: lightSwitchApplication.FurtherAction,
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.MyFurtherActions().filter("" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", ActionTitle)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Issue/IssueTitle)") + "").expand("Issue").expand("Issue.IssueType");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        BrowseMyIssues: $defineScreen(BrowseMyIssues, [
            {
                name: "MyIssues", kind: "collection", elementType: lightSwitchApplication.Issue,
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.MyIssues().filter("((((" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", IssueTitle)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", IssueDescription)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", IssueType/IssueTypeName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", AssignedTo/FirstName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", AssignedTo/LastName)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", AssignedTo/UserName)") + "").expand("IssueType").expand("AssignedTo");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
        ...
        showBrowseMyFurtherActions: $defineShowScreen(function showBrowseMyFurtherActions(options) {
            /// <summary>
            /// Asynchronously navigates forward to the BrowseMyFurtherActions screen.
            /// </summary>
            /// <param name="options" optional="true">
            /// An object that provides one or more of the following options:<br/>- beforeShown: a function that is called after boundary behavior has been applied but before the screen is shown.<br/>+ Signature: beforeShown(screen)<br/>- afterClosed: a function that is called after boundary behavior has been applied and the screen has been closed.<br/>+ Signature: afterClosed(screen, action : msls.NavigateBackAction)
            /// </param>
            /// <returns type="WinJS.Promise" />
            var parameters = Array.prototype.slice.call(arguments, 0, 0);
            return lightSwitchApplication.showScreen("BrowseMyFurtherActions", parameters, options);
        }),

        showBrowseMyIssues: $defineShowScreen(function showBrowseMyIssues(options) {
            /// <summary>
            /// Asynchronously navigates forward to the BrowseMyIssues screen.
            /// </summary>
            /// <param name="options" optional="true">
            /// An object that provides one or more of the following options:<br/>- beforeShown: a function that is called after boundary behavior has been applied but before the screen is shown.<br/>+ Signature: beforeShown(screen)<br/>- afterClosed: a function that is called after boundary behavior has been applied and the screen has been closed.<br/>+ Signature: afterClosed(screen, action : msls.NavigateBackAction)
            /// </param>
            /// <returns type="WinJS.Promise" />
            var parameters = Array.prototype.slice.call(arguments, 0, 0);
            return lightSwitchApplication.showScreen("BrowseMyIssues", parameters, options);
        }),
